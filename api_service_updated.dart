...
class ApiService {
  ...
  /// Simple decryption method (you may need to implement proper decryption based on your backend)
  Map<String, dynamic> _decryptData(String encryptedData) {
    try {
      // For now, assuming the data is base64 encoded JSON
      // You may need to implement proper decryption based on your backend encryption
