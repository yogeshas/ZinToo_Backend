...
def create_exchange_request(current_customer, order_id):
    ...
    try:
        ...
        print(f"[EXCHANGE ROUTE] Parsed fields: order_item_id={order_item_id}, product_id={product_id}, new_size={new_size}, new_quantity={new_quantity}, reason={reason}")
        ...
        res, status = create_exchange(customer_id, order_id, order_item_id, product_id, new_size, new_quantity, reason)
